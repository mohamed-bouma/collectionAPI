...
public class Referenciel {
    ...
    private static ArrayList<Referenciel> listeReferenciels = new ArrayList<Referenciel>();
    public static ArrayList<Referenciel> getListeReferenciels() {
        return listeReferenciels;
    }
